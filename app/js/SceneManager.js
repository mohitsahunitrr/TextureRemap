class SceneManager {
    constructor(application) {
        ...
        // CAMERA
        // this.camera = new THREE.CombinedCamera( window.innerWidth / 2, window.innerHeight / 2, 45, 1, 1000, - 500, 1000 );
        var aspect = window.innerWidth / window.innerHeight;
        this.cameraPersp = new THREE.PerspectiveCamera(45, aspect, 0.1, 3000);
        this.cameraOrtho = new THREE.OrthographicCamera(-10*aspect, 10*aspect, -10, 10, -1000, 1000);
